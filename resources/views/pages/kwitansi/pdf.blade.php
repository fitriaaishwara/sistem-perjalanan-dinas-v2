    ...
    <div class="font-11">
        <table class="w-100 table table-bordered">
            <tbody>
                <tr>
                    <td></td>
                    <td class="font-12">Kode Akun           : {{ $kwitansi->dataStaffPerjalanan->perjalanan[0]->mak->kode_mak }}</td>
                </tr>
                <tr>
                    <td></td>
        ...
        <table class="w-100 table table-bordered">
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width: 10%" class="font-12 text-center">:</td>
                    <td class="font-12">Biaya Perjalanan Dinas dalam rangka <br>{{ $kwitansi->dataStaffPerjalanan->perjalanan[0]->perihal_perjalanan }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="width: 10%" class="font-12 text-center">:</td>
                    <td class="font-12">
                        @if($kwitansi->dataStaffPerjalanan->perjalanan[0]->nomor_spd == null)
                            -
                        @else
                            {{ $kwitansi->dataStaffPerjalanan->perjalanan[0]->nomor_spd }}
                        @endif
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 10%" class="font-12 text-center">:</td>
                    <td class="font-12">
                        @if($kwitansi->dataStaffPerjalanan->perjalanan[0]->pada_tanggal == null)
                        -
                        @else
                            {{ $kwitansi->dataStaffPerjalanan->perjalanan[0]->pada_tanggal }}
                        @endif
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 10%" class="font-12 text-center">:</td>
                    <td class="font-12">
                        @if($kwitansi->dataStaffPerjalanan->tujuan_perjalanan[0] == null)
                        -
                        @else
                            {{ $kwitansi->dataStaffPerjalanan->tujuan_perjalanan[0]->tempat_berangkat }} ke: {{ $kwitansi->dataStaffPerjalanan->tujuan_perjalanan[0]->tempat_tujuan }}
                        @endif
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 10%" class="font-12 text-center">:</td>
                    <td class="font-12" style="font-weight: bold; background-color: #ffffff; border: 2px solid #030607; padding-left: 30px; padding-right: 30px; width:15%">{{ terbilang($kwitansi->dataStaffPerjalanan->perjalanan[0]->total_biaya) }}</td>
                </tr>
