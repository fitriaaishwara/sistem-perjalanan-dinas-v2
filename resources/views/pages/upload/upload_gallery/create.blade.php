        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('gallery/store') }}" id="galleryForm" name="galleryForm" enctype="multipart/form-data">
                    @csrf
                    <input id="id" type="hidden" class="form-control" name="id_tujuan_perjalanan" value="{{ $tujuan->id }}">
                    <div class="row mb-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row image-gallery">
                            ...
                            @if ($tujuan->uploadGallery->count() == 0)
                                <div class="col-12">
                                    <center>
                            ...
                            @else
                                @foreach($tujuan->uploadGallery as $item)
